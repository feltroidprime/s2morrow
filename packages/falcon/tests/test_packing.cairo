...
fn test_packing_roundtrip_simple() {
    let mut values: Array<Zq> = array![
        from_u16(0), from_u16(1), from_u16(2), from_u16(100), from_u16(12288),
        from_u16(6000), from_u16(3000), from_u16(9999), from_u16(5555),
        from_u16(42), from_u16(7777), from_u16(11111), from_u16(0), from_u16(12288),
        from_u16(1234), from_u16(5678), from_u16(8888), from_u16(4321),
    ];
    let mut i: usize = 18;
    while i != 512 {
