 ...
 * @param {Int32Array} s1
 * @param {Int32Array} pk_ntt
 * @returns {Uint16Array}
 */
export function create_verification_hint(s1, pk_ntt) {
    const ptr0 = passArray32ToWasm0(s1, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray32ToWasm0(pk_ntt, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.create_verification_hint(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU16FromWasm0(ret[0], ret[1]).slice();
 ...
 * @param {Int32Array} pk_time
 * @returns {Int32Array}
 */
export function ntt_public_key(pk_time) {
    const ptr0 = passArray32ToWasm0(pk_time, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.ntt_public_key(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @param {Uint16Array} pk_ntt
 * @returns {string[]}
 */
export function pack_public_key_wasm(pk_ntt) {
    const ptr0 = passArray16ToWasm0(pk_ntt, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.pack_public_key_wasm(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {number}
 */
export function public_key_length() {
    const ret = wasm.public_key_length();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function salt_length() {
    const ret = wasm.salt_length();
    return ret >>> 0;
}
 ...
 * @returns {any}
 */
export function sign(sk_bytes, message, salt) {
 ...
 * @returns {string[]}
 */
export function sign_for_starknet(sk_bytes, tx_hash, pk_ntt) {
    const ptr0 = passArray8ToWasm0(sk_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(tx_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray32ToWasm0(pk_ntt, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.sign_for_starknet(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {boolean}
 */
export function verify(vk_bytes, message, signature) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('falcon_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
