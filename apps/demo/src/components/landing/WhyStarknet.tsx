  ...
  return (
    <section id="why-starknet" className="starknet-section px-8 py-36 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mx-auto mt-8 max-w-3xl text-sm leading-relaxed text-falcon-text/45 sm:text-base">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-3">
          {POINTS.map((point) => (
            <div key={point.number} className="glass-card corner-brackets scan-hover stagger-child p-10">
              <span className="text-[10px] font-semibold tracking-[0.2em] text-falcon-accent/40">
                {point.number}
              </span>
              <h3 className="mt-4 text-sm font-semibold tracking-wide text-falcon-text/75">
                {point.title}
              </h3>
